...
public class ListTabsManager : MonoBehaviour
{
    ...
    [Header("OTHERS")]
    public Animator musicControlsAnimator;
    ...
    public void OpenMusicControls()
    {
        musicControlsAnimator.Play("Music Controls Normalize");
    }

    public void CloseMusicControls()
    {
        musicControlsAnimator.Play("Music Controls Minimize");
    }
}
